...
urlpatterns = [
    ...
    path('recipients/recipient/<int:pk>', RecipientView.as_view(), name='recipient' ),
    ...
    #рассылки
    path('mailing_list/list/', MailingListsListView.as_view(), name='mailing_lists' ),
    ...
    path('mailing_list/<int:pk>/turn_off', ChangeMailingListStatus.as_view(), name='turn_off'),
