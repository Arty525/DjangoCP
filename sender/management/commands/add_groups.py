...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        manager.permissions.add(view_mailing_list_permission, view_recipient_permission, view_user_list_permission,
                                view_message_permission, ban_permission, turn_off_permission)
        manager.save()
